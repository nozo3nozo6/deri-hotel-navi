...
function renderSubAdCards(ads, label) {
    ...
    const cards = ads.map((ad, i) => {
        ...
        const detailParts = [];
        if (priceText) detailParts.push(`<span class="ad-badge-recommend ad-badge-recommend--sm">オススメ</span> <span class="ad-price-diamond ad-price-diamond--sm">◆</span> <span class="ad-sub-price">${priceText}</span>`);
