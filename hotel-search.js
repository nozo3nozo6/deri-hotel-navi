...
function renderSubAdCards(ads, label) {
    ...
    const cards = ads.map((ad, i) => {
        ...
        const detailParts = [];
        if (priceText) detailParts.push(`<span class="ad-badge-recommend ad-badge-recommend--sm">オススメ</span><span style="margin:0 3px">🌟</span><span class="ad-sub-price">${priceText}</span>`);
