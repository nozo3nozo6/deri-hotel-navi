// mail-tester.com へのテスト送信（一回限り）
// 実行: node scripts/send-mail-tester.js

const TO = 'test-3dj5ne6wu@srv1.mail-tester.com';
const SHOP_NAME = 'メールテスター';
...
(async () => {
    console.log(`▶ mail-tester.com テスト送信`);
    console.log(`  宛先: ${TO}`);
    console.log(`  店舗名: ${SHOP_NAME}`);
    console.log(`  件名: ${SUBJECT}\n`);

    const res = await fetch('https://yobuho.com/api/send-mail.php', {
        method: 'POST',
    ...
    if (res.ok && json && json.success) {
        ...
        console.log(`\n▶ 次の手順:`);
        console.log(`  1. mail-tester.com に戻る`);
        console.log(`  2. 「Then check your score」ボタンをクリック`);
        console.log(`  3. スコアと改善点が表示されます`);
    } else {
