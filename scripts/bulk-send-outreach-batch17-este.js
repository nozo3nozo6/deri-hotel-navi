...
const RECIPIENTS = [
    { shop_name: "東京アロマスタイル", email: "tokyoaromastyle@gmail.com", area: "東京" },
    { shop_name: "アロマファンタジー高輪", email: "recruit@takanawa.aroma-fantasy.com", area: "東京" },
    { shop_name: "グランエステ東京 品川(ｼﾝﾃﾞﾚﾗｸﾞﾙｰﾌﾟ)", email: "rct@shinagawa-esthe.jp", area: "東京" },
    { shop_name: "アロマファンタジー恵比寿", email: "recruit@aroma-fantasy.com", area: "東京" },
    { shop_name: "やみつきエステ 渋谷店", email: "yamitsukispa@gmail.com", area: "東京" },
    { shop_name: "池袋アロマプリンセス(ユメオト)", email: "job@ik-aroma.com", area: "東京" },
    { shop_name: "アロマレーベル新橋(シンデレラグループ)", email: "rct@shinbashi-esthe.jp", area: "東京" },
    { shop_name: "池袋マル秘エステ", email: "maruhiesthe@gmail.com", area: "東京" },
    { shop_name: "錦糸町アロマエステ", email: "kinshichou.aroma@gmail.com", area: "東京" },
    { shop_name: "上野ミセスアロマ(ユメオト)", email: "job@unmrs-aroma.com", area: "東京" },
    { shop_name: "隙のあるエステ", email: "sukinoaru.esthe@gmail.com", area: "東京" },
    { shop_name: "今夜、美人エステ嬢と…", email: "info@bijin-esthe.net", area: "東京" },
    { shop_name: "大塚 虹いろ回春", email: "otsuka_nijiirokaishun@yahoo.co.jp", area: "東京" },
    { shop_name: "淫乱痴女エステ", email: "inranchijoesute@gmail.com", area: "東京" },
    { shop_name: "駅前スパ", email: "eki.spa4101@gmail.com", area: "東京" },
    { shop_name: "横浜ミセスアロマ(ユメオト)", email: "job@ykmrs-aroma.com", area: "神奈川" },
    { shop_name: "Aromaスク水女学院", email: "aromasukumizu@icloud.com", area: "神奈川" },
    { shop_name: "エステdeシンデレラ横浜(シンデレラグループ)", email: "rct@yokohama-esthe.jp", area: "神奈川" },
    { shop_name: "with SPA", email: "withspa045@gmail.com", area: "神奈川" },
    { shop_name: "横浜アロマプリンセス(ユメオト)", email: "job@yk-aroma.com", area: "神奈川" },
    { shop_name: "魔法のエステ(マーベリックグループ)", email: "magical_esthe@icloud.com", area: "神奈川" },
    { shop_name: "AROMA PHIL", email: "aroma.phil86@gmail.com", area: "神奈川" },
    { shop_name: "アロマ新横浜", email: "job.massage.yokohama@gmail.com", area: "神奈川" },
    { shop_name: "千葉アロマプリンセス(ユメオト)", email: "job@cb-aroma.com", area: "千葉" },
    { shop_name: "アロマヴィーナスグループ", email: "job-funabashi@aroma-v.com", area: "千葉" },
    { shop_name: "アロマヴィーナス 柏店", email: "aroma.kashiwa@i.softbank.jp", area: "千葉" },
    { shop_name: "錦糸町ミセスアロマ(ユメオト)", email: "job@ksmrs-aroma.com", area: "千葉" },
    { shop_name: "アロマージュ大宮店", email: "info@aromage-omiya.com", area: "埼玉" },
    { shop_name: "埼玉ミセスアロマ(ユメオト)", email: "job@stmrs-aroma.com", area: "埼玉" },
    { shop_name: "埼玉アロマプリンセス(ユメオト)", email: "job@st-aroma.com", area: "埼玉" },
    { shop_name: "Aroma Z", email: "aroma_z11@icloud.com", area: "青森" },
    { shop_name: "Aroma Woopz(回春・性感マッサージ)", email: "aromawoopz.sendai@gmail.com", area: "宮城" },
    { shop_name: "やみつきエステ2nd 札幌店", email: "yamitsuki.2nd.spa@gmail.com", area: "北海道" }
];
