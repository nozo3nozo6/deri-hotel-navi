...
const RECIPIENTS = [
    { shop_name: '大分Ritz Aroma様', email: 'g.p@i.softbank.jp', area: '大分県' },
    { shop_name: '大分La Rouge', email: 'g.p@i.softbank.jp', area: '大分県' },
    { shop_name: '大分ド淫乱妻倶楽部様', email: 'tsumakurabu@softbank.ne.jp', area: '大分県' },
    { shop_name: '大分リラリラ', email: 'rira2888@gmail.com', area: '大分県' },
    { shop_name: '大分Club LUMINE様', email: 'grand_phoenix@i.softbank.jp', area: '大分県' },
    { shop_name: '大分アップルティ大分店', email: 'ap9191@ezweb.ne.jp', area: '大分県' },
    { shop_name: '佐賀佐賀デリヘル358', email: 'sagaderi358@gmail.com', area: '佐賀県' },
];
