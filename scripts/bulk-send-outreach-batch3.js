...
const RECIPIENTS = [
    { shop_name: '佐賀VERY（ヴェリィ）様', email: 'very4615@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀ディオーネ様', email: 'dione.group10@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀人妻デリヘル「デリ夫人」様', email: 'delifujin@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀ぽちゃ雪姫～佐賀ぽちゃかわ専門店様', email: 'chankosaga@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀桃色奥様様', email: 'kyujin@saga-momoiro-group.com', area: '佐賀県' },
    { shop_name: '佐賀激安ピーチ様', email: 'kyujin@saga-momoiro-group.com', area: '佐賀県' },
    { shop_name: '佐賀ぴちぴちピーチ様', email: 'info@saga-momoiro-group.com', area: '佐賀県' },
    { shop_name: '佐賀COURREGES 唐津', email: 'courregesgroup@ezweb.ne.jp', area: '佐賀県' },
    { shop_name: '佐賀人妻ディオーネ', email: 'dione.group10@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀Courreges', email: 'hashiguchi0122@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀吉野ヶ里人妻デリヘル「デリ夫人」', email: 'fujin.yoshinogari@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀ROYAL-X(ロイヤルエックス)佐賀店', email: 'royalx.saga@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀おっぱい専門店 Chiffon', email: 'chiffon.saga@gmail.com', area: '佐賀県' },
    { shop_name: '佐賀熟女の薫り', email: 'minorino-aki@docomo.ne.jp', area: '佐賀県' },
    { shop_name: '佐賀美的', email: 'biteki-group@au.com', area: '佐賀県' },
    { shop_name: '佐賀Happy Life（ハッピーライフ）', email: 'courregesgroup@ezweb.ne.jp', area: '佐賀県' },
    { shop_name: '熊本アイコレクション女学院', email: 'liengroup.kumamoto@gmail.com', area: '熊本県' },
    { shop_name: '熊本Hills Premier', email: 'takechi.1024r@docomo.ne.jp', area: '熊本県' },
    { shop_name: '熊本GALAXY PLUS', email: 'galaxy-job@i.softbank.jp', area: '熊本県' },
    { shop_name: '熊本DH JPR', email: 'pp.renraku@icloud.com', area: '熊本県' },
];
