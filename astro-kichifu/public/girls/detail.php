...
if (!$g) {
    ...
    site_header();
    echo '<main><div class="wrap-md" style="padding:80px 24px;text-align:center"><p class="empty-state">ページが見つかりません</p><p style="margin-top:24px"><a href="/girls" class="back-link">← すけべな女の子に戻る</a></p></div></main>';
    site_footer();
    exit;
}
